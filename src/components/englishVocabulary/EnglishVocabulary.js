              ...
              <Row style={{ alignItems: "center" }} className="p-5 g-5">
                    ...
                    className="animate__animated animate__backInLeft text-center m-auto mt-5"
                      style={{
                         ...
                         fontSize: "25px",
                         width:"700px"
                       }}>Discover this must-read book to enhance your English language skills."</h2>
              </Row>
              <Row>
                    <Col className="col-12 col-md-6 text-center">
                       <img style={{width:"320px" , height:"400px"}} className="mt-5 img-fluid" src={EnglishVocabularyInUseImage} />
                    </Col>
                    <Col className="col-12 col-md-6">
                       ...
                       <a href={EnglishVocabularyInUseBook} target='_blank'>
