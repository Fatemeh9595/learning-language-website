...
import GermanVocabularyInUseBook from "../../assets/books/Collins_German_3000_words_and_phrases.pdf";
import GermanVocabularyInUseImage from "../../assets/images/german-vocabulary.jpg";

function GermanVocabulary(){
  return(
    <>
      <MyTab />
      <MyNavbar/>
      <Container>
        ...
        <Row style={{ alignItems: "center" }} className="p-5 g-5">
          ...
          >
            Discover this must-read book to enhance your German language skills.
          </h2>
        </Row>
        ...
        <Row>
          <Col className="col-12 col-md-6 text-center">
            <img
              ...
              src={GermanVocabularyInUseImage}
              alt="Cover of Collins German 3000 Words and Phrases"
            />
          </Col>
          <Col className="col-12 col-md-6">
            <h2 className="mt-5" style={{overflowY:"hidden", fontFamily:"Nerko One"}}>German : 3000 words and phrases</h2>
            <p className="mt-5 fw-bold">Writter : <span className="pt-3 text-primary fw-bold">Collins</span></p>
            <a href={GermanVocabularyInUseBook} target="_blank" rel="noreferrer">
