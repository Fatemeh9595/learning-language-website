            ...
            <Row style={{marginBottom:"100px"}}>
              <Table style={{marginTop:"100px" , width:"1000px" , textAlign:"center" , margin:"auto"}} striped bordered hover>
                 ...
                 <tbody>
                   <tr>
                     <td>Nouns</td>
                     <td>Words that name people, places, things, or ideas</td>
                     <td>car, house, love, freedom, teacher</td>
                   </tr>
                   <tr>
                     <td>Pronouns</td>
                     <td>Words that replace nouns</td>
                     <td>he, she, it, they, we, I</td>
                   </tr>
                   <tr>
                     <td>Verbs</td>
                     <td>Words that express actions or states</td>
                     <td>run, eat, is, become, drive, swim</td>
                   </tr>
                   <tr>
                     <td>Adjectives</td>
                     <td>Words that describe nouns or pronouns</td>
                     <td>big, happy, red, tall, beautiful, fast</td>
                   </tr>
                   <tr>
                     <td>Adverbs</td>
                     <td>Words that describe verbs, adjectives, or other adverbs</td>
                     <td>quickly, very, well, silently, carefully</td>
                   </tr>
                   <tr>
                     <td>Prepositions</td>
                     <td>Words that show relationships between words</td>
                     <td>on, in, under, between, during, near</td>
                   </tr>
                   <tr>
                     <td>Conjunctions</td>
                     <td>Words that connect clauses, sentences, or words</td>
                     <td>and, but, or, because, although, if</td>
                   </tr>
                   <tr>
                     <td>Interjections</td>
                     <td>Words used to express emotions or reactions</td>
                     <td>wow, oh, ouch, hey, yikes</td>
                   </tr>
                   <tr>
                     <td>Articles</td>
                     <td>Words that define a noun as specific or unspecific</td>
                     <td>the, a, an</td>
                   </tr>
                   <tr>
                     <td>Determiners</td>
                     <td>Words that specify which noun is being referred to</td>
                     <td>this, that, these, those, many, few</td>
                   </tr>
                   <tr>
                     <td>Modal Verbs</td>
                     <td>Verbs used to indicate possibility, necessity, or ability</td>
                     <td>can, may, should, must, would</td>
                   </tr>
                   <tr>
                     <td>Contractions</td>
                     <td>Shortened forms of words</td>
                     <td>can't (cannot), won't (will not), I'm (I am)</td>
                   </tr>
                   <tr>
                     <td>Phrasal Verbs</td>
                     <td>Verbs combined with prepositions or adverbs</td>
                     <td>look after, take off, give up, break down</td>
                   </tr>
                 </tbody>
              </Table>
            </Row>
            <Row style={{ alignItems: "center" }} className="p-5 g-5">
                    ...
                    className="animate__animated animate__backInLeft text-center m-auto mt-5"
                      style={{
                         ...
                         fontSize: "25px",
                         width:"700px"
                       }}>Discover this must-read book to enhance your English Grammer skills."</h2>
              </Row>
              <Row>
                    <Col className="col-12 col-md-6 text-center">
                       <img style={{width:"320px" , height:"400px"}} className="mt-5 img-fluid" src={EnglishGrammerInUseImage} />
                    </Col>
                    <Col className="col-12 col-md-6">
                       ...
                       <a href={EnglishGrammerInUseBook} target='_blank'>
