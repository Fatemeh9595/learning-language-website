    ...
    <>
      ...
      <Container>
        ...
        <Row style={{ alignItems: "center" }} className="p-5 g-5">
          ...
          >
            Discover this must-read book to enhance your French language skills.
          </h2>
        </Row>
        ...
        <Row>
          <Col className="col-12 col-md-6 text-center">
            <img
              ...
              src={FrenchVocabularyInUseImage}
              alt="Cover of Collins Easy Learning French Words"
            />
          </Col>
          <Col className="col-12 col-md-6">
            ...
            <a href={FrenchVocabularyInUseBook} target="_blank" rel="noreferrer">
